...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_mentions(self):
        user_mentions = [[{"screen_name": "nikitheblogger", "name": "Neverforgetniki", "id": 809188392089092097,
                           "id_str": "809188392089092097", "indices": [3, 18]}],
                         [],
                         [{"screen_name": "sagt_mit", "name": "Sie sagt es mit Bildern", "id": 1511959918777184256,
                           "id_str": "1511959918777184256", "indices": [3, 12]}],
                         [],
                         [{"screen_name": "Kryptonoun", "name": "Kryptoguru", "id": 951051508321345536,
                           "id_str": "951051508321345536", "indices": [3, 14]},
                          {"screen_name": "WRi007", "name": "Wolfgang Berger", "id": 1214543251283357696,
